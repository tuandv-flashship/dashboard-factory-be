...
# ── Shift Schedule ───────────────────────
DAILY_SHIFT_JOB_AT=00:00      # Chạy 1h10 phút trước ca sớm nhất
...
| `CreateDailyShiftJob`      | `00:00` hàng ngày | Tự tạo Ca 1, fetch tồn đầu ngày từ Fplatform                |
