...
SUM(IF(s.created_at >= CONVERT_TZ(':estimate_date 00:00:00', 'US/Central', '+7:00') AND s.created_at <= CONVERT_TZ(':estimate_date 23:59:59', 'US/Central', '+7:00'), 1, 0)) AS da_lam
FROM order_status o
