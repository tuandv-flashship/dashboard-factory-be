...
final class ReasonCodeSeeder_2 extends Seeder
{
    public function run(): void
    {
        ...
        // ═══════════════════════════════════════════════════════════════════
        // DTG PRINT (scope_dept = 'dtg_print')
        // ═══════════════════════════════════════════════════════════════════
        $this->seedDept(
            dept: 'dtg_print',
            machine: $machine,
            ...
            subItems: [
                // [category_var_key, code_suffix, label]
                ['machine',  'may-in-dtg',          'Máy in DTG'],
                ['machine',  'may-say',             'Máy sấy'],
                ['human',    'operator',            'Operator máy in'],
                ['human',    'nv-qc',               'NV kiểm tra chất lượng'],
                ['human',    'nv-phu-tro',          'Nhân viên phụ trợ'],
                ['material', 'muc-in',              'Mực in (Ink)'],
                ['material', 'tien-xu-ly',          'Nước tiền xử lý (Pre-treatment)'],
                ['process',  'chuan-bi-file',       'Chuẩn bị file in'],
                ['process',  'cai-dat-may',         'Cài đặt máy in'],
                ['process',  'kiem-soat-moi-truong','Kiểm soát môi trường'],
                ['process',  'cho-doi',             'Chờ đợi / Phụ thuộc'],
            ...
            errors: [
                // [sub_item_code_suffix, error_label]
                ['may-in-dtg',          'Tắc đầu phun (clogged printhead)'],
                ['may-in-dtg',          'Lệch đầu phun (printhead misalignment)'],
                ['may-in-dtg',          'Lỗi mực trắng (white ink issue)'],
                ['may-in-dtg',          'Mực bị nhòe / smudging'],
                ['may-in-dtg',          'Màu sai / lệch màu (color mismatch)'],
                ['may-in-dtg',          'Hình bị mờ / blur'],
                ['may-in-dtg',          'Lỗi phần mềm RIP'],
                ['may-in-dtg',          'Máy báo lỗi / error code'],
                ['may-in-dtg',          'Máy dừng đột ngột / treo'],
                ['may-in-dtg',          'Bảo trì định kỳ'],
                ['may-in-dtg',          'Khác'],
                ['may-say',             'Nhiệt độ không đạt / không ổn định'],
                ['may-say',             'Băng tải bị kẹt'],
                ['may-say',             'Máy dừng đột ngột / treo'],
                ...
                ['muc-in',              'Sai loại mực'],
                ['muc-in',              'Khác'],
                ['tien-xu-ly',          'Hết dung dịch'],
                ['tien-xu-ly',          'Phun không đều'],
                ['tien-xu-ly',          'Dung dịch kém chất lượng'],
                ['tien-xu-ly',          'Khác'],
                ['chuan-bi-file',       'File thiết kế sai / lỗi'],
                ['chuan-bi-file',       'File chưa được duyệt'],
                ['chuan-bi-file',       'Sai kích thước / resolution'],
                ...
                ['kiem-soat-moi-truong','Khác'],
                ['cho-doi',             'Chờ file từ bộ phận khác'],
                ['cho-doi',             'Chờ nguyên vật liệu (áo/mực)'],
                ['cho-doi',             'Chờ sửa máy'],
                ['cho-doi',             'Chờ xác nhận từ quản lý'],
                ['cho-doi',             'Hết việc'],
                ['cho-doi',             'Khác'],
