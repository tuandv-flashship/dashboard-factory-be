...
final readonly class MemberMobileClient extends ParentValue implements Client
{
    private const ID_CONFIG_KEY = 'appSection-authentication.clients.mobile.id';
    private const SECRET_CONFIG_KEY = 'appSection-authentication.clients.mobile.secret';
    ...
    public static function create(): self
    {
        ...
        Assert::true(
            ...
            'The mobile client id must be a non-empty string or an integer',
        );
        Assert::stringNotEmpty($plainSecret, 'The mobile client secret must be a non-empty string');
