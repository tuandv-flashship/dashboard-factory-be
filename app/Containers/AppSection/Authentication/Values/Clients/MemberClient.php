...
final readonly class MemberClient extends ParentValue implements Client
{
    private const ID_CONFIG_KEY = 'appSection-authentication.clients.member.id';
    private const SECRET_CONFIG_KEY = 'appSection-authentication.clients.member.secret';
    ...
    public static function create(): self
    {
        ...
        Assert::true(
            ...
            'The member client id must be a non-empty string or an integer',
        );
        Assert::stringNotEmpty($plainSecret, 'The member client secret must be a non-empty string');
