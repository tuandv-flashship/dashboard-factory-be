...
/**
 * Seeds alerts for the current factory deployment.
 *
 * Uses config('factory.current') to determine which alerts to seed.
 *
...
final class AlertSeeder_1 extends Seeder
{
    public function run(): void
    {
        ...
        $alerts = match ($factory) {
            'FLS' => [
                [
                    'severity' => 'critical',
                    'department' => 'Print',
                    'time' => '10:42',
                    'message' => 'Máy in DTF-03 ngừng hoạt động — cần bảo trì',
                    'line' => 'dtf',
                ],
                [
                    'severity' => 'warning',
                    ...
                    'time' => '10:15',
                    'message' => 'Máy dán nhãn LBL-01 đang bảo trì — dự kiến 30 phút',
                    'line' => 'dtf',
                ],
                [
                    'severity' => 'info',
            ...
            'PD' => [
                [
                    ...
                    'department' => 'Mock Up',
                    'time' => '09:45',
                    'message' => 'Máy SEW-03 ngừng — cần thay kim',
                    'line' => 'dtf',
                ],
                [
                    'severity' => 'warning',
