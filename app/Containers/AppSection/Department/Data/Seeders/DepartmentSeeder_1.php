...
final class DepartmentSeeder_1 extends Seeder
{
    public function run(): void
    {
        ...
        Department::insert([
            ...
            // DTG (1)
            ['production_line_id' => $dtg->id, 'code' => 'print', 'label' => 'In ấn DTG', 'label_en' => 'DTG Print', 'icon' => 'Printer', 'unit' => 'print', 'kpi_per_hour' => 400, 'factory' => 'PD', 'sort_order' => 1, 'is_active' => true, 'can_increase_productivity' => true, 'created_at' => $now, 'updated_at' => $now],
            // Pick (3)
